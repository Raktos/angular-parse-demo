...
angular.module('ToDoApp', ['ui.bootstrap'])
    .config(function($httpProvider) {
        ...
        //My Parse
//        $httpProvider.defaults.headers.common['X-Parse-Application-Id'] = 'kbaR8w9na7UAumwfYW4KSgnTdVMIx1lPHlM3EzyV';
//        $httpProvider.defaults.headers.common['X-Parse-REST-API-Key'] = 'hZquhKfIQ166MH5m13gJy0V8srYLOdvsLxs6Uf8a';
    ...
    .controller('TasksController', function($scope, $http) {
        ...
        $scope.addTask = function() {
            ...
            $http.post(tasksUrl, $scope.newTask)
                .success(function(responseData) {
                    //get object ID so we don't forget which task the new one is
        ...
        $scope.updateTask = function(task) {
            $http.put(tasksUrl + '/' + task.objectId, task)
                .success(function() {
                    //maybe show feedback or something
                })
                .error(function() {
                    $scope.errorMessage = err;
                });
